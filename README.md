...
### Modelo
  ...
  - Se tienen tres neuronas en capa de salida con activación *softmax*.
  ...
  - Se usa TensorBoard para visualizar el ntrenamiento en tiempo real.
...
### Test del modelo
  ...
  > *Accuracy* tan alto se explica dado la poca cantidad de instancias para el test (5% del dataset, correspondiente a 5 secuencias de video).
